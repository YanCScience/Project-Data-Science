import strimport streamlit as st
import pandas as pd
import numpy as np
...
# Add a note
st.markdown("**Catatan:** Ini adalah alat prediksi berbasis model Random Forest yang dilatih dengan SMOTE dan GridSearchCV. Konsultasikan dengan tenaga medis profesional untuk saran medis.")eamlit as st
import pandas as pd
import numpy as np
from sklearn.preprocessing import StandardScaler
import joblib
